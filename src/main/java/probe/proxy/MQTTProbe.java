...
/*    public static void main(String[] args) {
    ...
    public MQTTProbe(int unicastPort, int multicastPort, String multicastAddress, StatusGetter statusGetter, SecretKey aesKey) {
